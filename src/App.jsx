...
const PROJECTS = [
  ...
  },
  {
    ...
    description: "I am always working on something. Check back in the future!",
    tags: [],
    venue: "TBD",
    period: "2025",
    isPlaceholder: true,
      ...
      {currentProject ? (
        ...
        <>
          ...
          <section id="about" aria-label="About Me" className="section-padding" style={{ paddingTop: "100px", paddingBottom: "100px", maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
            ...
            <FadeIn delay={0.1}>
              <div style={{ maxWidth: "860px", margin: "0 auto" }}>
                ...
                <p className="about-text" style={{ color: t.textMuted, lineHeight: 1.8 }}>Currently, I'm a Business Intelligence Analyst, within Commercial Data & Analytics at S&P Global. I support the Dow Jones Indices business by helping drive compliance oversight, control effectiveness, and process improvement initiatives that enhance operational excellence and support business objectives. When I'm not analyzing data, you can find me reading about the recent news on AI, exploring engineering design, or planning my next project.</p>
              </div>
            </FadeIn>
          </section>
          ...
          <footer className="section-padding" style={{ paddingTop: "40px", paddingBottom: "40px", maxWidth: "1200px", margin: "0 auto", borderTop: `1px solid ${t.navBorder}`, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px", position: "relative", zIndex: 1 }}>
            ...
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: "12px", color: t.footerText }}>Built with intention and free spirit</span>
          </footer>
        </>
      )}
      </main>
